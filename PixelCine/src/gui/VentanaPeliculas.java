...
public class VentanaPeliculas extends JFrame {
	...
	public VentanaPeliculas(Cliente c, String fecha) {
		...
		String[] titulos = { "Nombre", "Duración", "Categoría", "Actor principal" };
		...
		for (Pelicula p : peliculas) {
			Object[] datos = { p.getNombre(), p.getDuracion(), p.getCategoria(),
					p.getActorPrincipal() };
	...
	public static ArrayList<Pelicula> cargarPeliculasTablaCsv() {
		...
		String input = "resources/data/Peliculas.csv";
